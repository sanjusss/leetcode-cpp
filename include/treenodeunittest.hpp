...
namespace Microsoft
{
    namespace VisualStudio
    {
        namespace CppUnitTestFramework
        {
            ...
            inline std::vector<std::shared_ptr<TreeNode>> createTreeNodeAutoRemovers(TreeNode* root)
            {
            ...
            {
                return L"\nuse \"TreeNode\" or \"shared_ptr<TreeNode>\" instead of \"TreeNode*\" in Assert::areEqual or Assert::notEqual !\n";
            }
            ...
            inline bool operator == (const std::shared_ptr<TreeNode>& a, const std::shared_ptr<TreeNode>& b)
            {
                return ToString(a) == ToString(b);
            }
