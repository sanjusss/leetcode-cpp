...
namespace UnitTestC1xx
{
    ...
    public:
        ...
        void check(int n, string edgesSrc, int distanceThreshold, int expected)
        {
            auto edges = toInt2DArray(edgesSrc);
            Solution sln;
            auto actual = sln.findTheCity(n, edges, distanceThreshold);
